...
function helpMsg(){
	...
	echo "*---------------*"
	echo ""
	echo "	e	Execute:	Executes core function of txtDir"
	echo "	f	File:		Prompts user for plan.txt if not in set path"
	echo "	n	New:		Prompts user to write new plan.txt in set path"
	echo "--------------------------------------------------------------------------------"
}
